...
export const COURSES = [
  // ── Semester 1 ──
  {
    code: 'CS101', name: 'Mathematics I', credits: 4, semester: 1,
    facultyId: 'FAC-002', facultyName: 'Prof. Ankit Sharma',
    type: 'Compulsory', department: 'CS', enrolled: 60, status: 'Inactive',
  ...
  {
    code: 'CS102', name: 'Programming Fundamentals', credits: 4, semester: 1,
  ...
  {
    code: 'CS103', name: 'Digital Logic Design', credits: 3, semester: 1,
    facultyId: 'FAC-002', facultyName: 'Prof. Ankit Sharma',
    type: 'Compulsory', department: 'CS', enrolled: 60, status: 'Inactive',
    activeSemester: false,
  ...
  // ── Semester 2 ──
  {
    ...
    facultyId: 'FAC-002', facultyName: 'Prof. Ankit Sharma',
    type: 'Compulsory', department: 'CS', enrolled: 58, status: 'Inactive',
    activeSemester: false,
  ...
  {
    code: 'CS202', name: 'Mathematics II', credits: 4, semester: 2,
    facultyId: 'FAC-002', facultyName: 'Prof. Ankit Sharma',
    type: 'Compulsory', department: 'CS', enrolled: 58, status: 'Inactive',
    activeSemester: false,
  ...
  {
    code: 'CS203', name: 'Object-Oriented Programming', credits: 3, semester: 2,
    facultyId: 'FAC-001', facultyName: 'Dr. Pooja Singh',
    type: 'Compulsory', department: 'CS', enrolled: 58, status: 'Inactive',
    activeSemester: false,
  ...
  // ── Semester 3 ──
  {
    code: 'CS301', name: 'Operating Systems', credits: 4, semester: 3,
    facultyId: 'FAC-001', facultyName: 'Dr. Pooja Singh',
    type: 'Compulsory', department: 'CS', enrolled: 55, status: 'Inactive',
    activeSemester: false,
  ...
  {
    code: 'CS302', name: 'Design & Analysis of Algorithms', credits: 4, semester: 3,
    facultyId: 'FAC-002', facultyName: 'Prof. Ankit Sharma',
    type: 'Compulsory', department: 'CS', enrolled: 55, status: 'Inactive',
    activeSemester: false,
  ...
  {
    code: 'CS401', name: 'Database Management Systems', credits: 4, semester: 4,
    facultyId: 'FAC-001', facultyName: 'Dr. Pooja Singh',
    type: 'Compulsory', department: 'CS', enrolled: 52, status: 'Active',
    activeSemester: true,
  ...
  {
    code: 'CS402', name: 'Software Engineering', credits: 3, semester: 4,
    facultyId: 'FAC-002', facultyName: 'Prof. Ankit Sharma',
    type: 'Compulsory', department: 'CS', enrolled: 52, status: 'Active',
    activeSemester: true,
  ...
  {
    code: 'CS403', name: 'Artificial Intelligence', credits: 4, semester: 4,
    facultyId: 'FAC-002', facultyName: 'Prof. Ankit Sharma',
    type: 'Compulsory', department: 'CS', enrolled: 52, status: 'Active',
    activeSemester: true,
  ...
  {
    code: 'CS404E', name: 'Web Development', credits: 3, semester: 4,
    facultyId: 'FAC-001', facultyName: 'Dr. Pooja Singh',
    type: 'Elective', department: 'CS', enrolled: 30, status: 'Active',
    activeSemester: true,
  ...
  {
    code: 'CS405E', name: 'Cloud Computing', credits: 3, semester: 4,
    facultyId: 'FAC-002', facultyName: 'Prof. Ankit Sharma',
    type: 'Elective', department: 'CS', enrolled: 22, status: 'Active',
    activeSemester: true,
  ...
  {
    code: 'CS406E', name: 'Cyber Security', credits: 3, semester: 4,
    facultyId: 'FAC-001', facultyName: 'Dr. Pooja Singh',
    type: 'Elective', department: 'CS', enrolled: 18, status: 'Active',
    activeSemester: true,
