...
export const TIMETABLE_SLOTS = [
  ...
  {
    id: 1, courseCode: 'CS401', courseName: 'Database Management Systems',
  ...
  {
    id: 2, courseCode: 'CS401', courseName: 'Database Management Systems',
  ...
  {
    id: 3, courseCode: 'CS402', courseName: 'Software Engineering',
  ...
  {
    id: 4, courseCode: 'CS403', courseName: 'Artificial Intelligence',
  ...
  {
    id: 5, courseCode: 'CS403', courseName: 'Artificial Intelligence',
    type: 'Lab', room: 'AI-Lab', facultyName: 'Prof. Ankit Sharma',
    days: [2], startHour: 15, endHour: 17,     // Wed 3–5 PM
    color: 'bg-purple-100 border-purple-400 text-purple-900',
  },

  // ── CS404E: Web Development (Elective) ──
  {
    id: 6, courseCode: 'CS404E', courseName: 'Web Development',
  ...
  {
    id: 7, courseCode: 'CS404E', courseName: 'Web Development',
  ...
  // ── CS402 Tutorial ──
  {
    id: 8, courseCode: 'CS402', courseName: 'Software Engineering',
